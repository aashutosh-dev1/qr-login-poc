...
Serializer<GDeviceAuthReq> _$gDeviceAuthReqSerializer =
    new _$GDeviceAuthReqSerializer();
Serializer<GaddDeviceReq> _$gaddDeviceReqSerializer =
    new _$GaddDeviceReqSerializer();
...
class _$GDeviceAuthReqSerializer
  ...
  GDeviceAuthReq deserialize(
      ...
      {FullType specifiedType = FullType.unspecified}) {
    final result = new GDeviceAuthReqBuilder();
...
class _$GaddDeviceReqSerializer implements StructuredSerializer<GaddDeviceReq> {
  ...
  GaddDeviceReq deserialize(
      Serializers serializers, Iterable<Object?> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new GaddDeviceReqBuilder();
...
class _$GDeviceAuthReq extends GDeviceAuthReq {
  ...
  factory _$GDeviceAuthReq([void Function(GDeviceAuthReqBuilder)? updates]) =>
      (new GDeviceAuthReqBuilder()..update(updates))._build();
  ...
  _$GDeviceAuthReq._(
      ...
      this.context})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(vars, r'GDeviceAuthReq', 'vars');
  ...
  @override
  GDeviceAuthReqBuilder toBuilder() =>
      new GDeviceAuthReqBuilder()..replace(this);
...
class GDeviceAuthReqBuilder
  ...
  _i3.GDeviceAuthVarsBuilder get vars =>
      _$this._vars ??= new _i3.GDeviceAuthVarsBuilder();
  ...
  _i2.GDeviceAuthDataBuilder get optimisticResponse =>
      _$this._optimisticResponse ??= new _i2.GDeviceAuthDataBuilder();
...
class _$GaddDeviceReq extends GaddDeviceReq {
  ...
  factory _$GaddDeviceReq([void Function(GaddDeviceReqBuilder)? updates]) =>
      (new GaddDeviceReqBuilder()..update(updates))._build();
  ...
  _$GaddDeviceReq._(
      ...
      this.context})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(vars, r'GaddDeviceReq', 'vars');
    BuiltValueNullFieldError.checkNotNull(
  ...
  @override
  GaddDeviceReqBuilder toBuilder() => new GaddDeviceReqBuilder()..replace(this);
...
class GaddDeviceReqBuilder
  ...
  _i3.GaddDeviceVarsBuilder get vars =>
      _$this._vars ??= new _i3.GaddDeviceVarsBuilder();
  ...
  _i2.GaddDeviceDataBuilder get optimisticResponse =>
      _$this._optimisticResponse ??= new _i2.GaddDeviceDataBuilder();
