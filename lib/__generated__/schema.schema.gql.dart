...
import 'package:gql_code_builder/src/serializers/default_scalar_serializer.dart'
    as _i2;
import 'package:qr_login_poc/__generated__/serializers.gql.dart' as _i1;
...
abstract class GAddDeviceInput
  ...
  GOpenIddictResponseDtoInput get request;
...
abstract class GLongOperationFilterInput
  ...
  BuiltList<GLong?>? get Gin;
  BuiltList<GLong?>? get nin;
  GLong? get gt;
  GLong? get ngt;
  GLong? get gte;
  GLong? get ngte;
...
abstract class GOpenIddictResponseDtoInput
    implements
        Built<GOpenIddictResponseDtoInput, GOpenIddictResponseDtoInputBuilder> {
  GOpenIddictResponseDtoInput._();

  factory GOpenIddictResponseDtoInput(
          [void Function(GOpenIddictResponseDtoInputBuilder b) updates]) =
  ...
  String? get username;
  String? get deviceId;
  static Serializer<GOpenIddictResponseDtoInput> get serializer =>
      _$gOpenIddictResponseDtoInputSerializer;

  Map<String, dynamic> toJson() => (_i1.serializers.serializeWith(
        GOpenIddictResponseDtoInput.serializer,
        this,
      ) as Map<String, dynamic>);

  static GOpenIddictResponseDtoInput? fromJson(Map<String, dynamic> json) =>
      _i1.serializers.deserializeWith(
        GOpenIddictResponseDtoInput.serializer,
        json,
      );
...
abstract class GTimeSpan implements Built<GTimeSpan, GTimeSpanBuilder> {
  ...
  static Serializer<GTimeSpan> get serializer =>
      _i2.DefaultScalarSerializer<GTimeSpan>(
